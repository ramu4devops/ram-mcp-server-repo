...
python3 challenges/challenge1/server_sse.py &
python3 challenges/challenge2/server_sse.py &
python3 challenges/challenge3/server_sse.py &
python3 challenges/challenge4/server_sse.py &
python3 challenges/challenge5/server_sse.py &
python3 challenges/challenge6/server_sse.py &
python3 challenges/challenge7/server_sse.py &
python3 challenges/challenge8/server_sse.py &
python3 challenges/challenge9/server_sse.py &
python3 challenges/challenge10/server_sse.py &
python3 challenges/challenge1/server_http.py &
python3 challenges/challenge2/server_http.py &
python3 challenges/challenge3/server_http.py &
python3 challenges/challenge4/server_http.py &
python3 challenges/challenge5/server_http.py &
python3 challenges/challenge6/server_http.py &
python3 challenges/challenge7/server_http.py &
python3 challenges/challenge8/server_http.py &
python3 challenges/challenge9/server_http.py &
python3 challenges/challenge10/server_http.py &
